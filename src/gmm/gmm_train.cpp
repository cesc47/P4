...
int main(int argc, const char *argv[]) {
  ...
  /// \HECHO Initialize GMM from data; initially, you should implement random initialization.
  //Random inicialization

  if(gmm.random_init(data, nmix) != 0){
    return -1;
  }
  ...
  if(gmm.em(data, DEF_ITERATIONS, DEF_THR, 01) != 0){
    return -1;
  }
